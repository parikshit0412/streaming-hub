...
import { Movie, DEFAULT_WATCHLIST_MOVIES } from '@streaming-hub/shared-data';
...
const DEFAULT_MOVIES = DEFAULT_WATCHLIST_MOVIES;
    ...
    if (savedSession) {
      try {
        ...
        if (parsed && parsed.email) {
          setAuthToken(parsed.token || 'mock-jwt-token-streamhub-secret-xyz');
          setCurrentUser({ email: parsed.email, name: parsed.name || 'Test User' });
        }
      } catch (e) {
